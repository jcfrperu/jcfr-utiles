...
public class NumeroALetrasConverter {
    ...
    private String decena(int numero) {
        ...
        if (numero >= 90 && numero <= 99) {
            ...
            else num_letra = "veinti".concat(unidad(numero - 20));
    ...
    private String centena(int numero) {
        if (numero >= 100) {
            if (numero >= 900 && numero <= 999) {
                ...
                if (numero == 100) num_letra = "cien ";
                else num_letra = "ciento ".concat(decena(numero - 100));
            }
    ...
    public String convertirLetras(int numero) {
        ...
        String num_letras = decmillon(numero);
